...
API_PUBLISHABLE_KEY = 'ISPubKey_test_0e9a02cd-020b-457f-a060-1f222b2b2668'

API_TOKEN = 'ISSecretKey_test_b289727e-c6b2-4df0-b2ec-89d8f53b0172'
...
def place_order():
    ...
    if customer_cart:
        try:
            ...
            create_order_response = service.collect.mpesa_stk_push(phone_number='2549917783432 ', email=current_user.email,
